...
if(isset($_POST['submit'])){
  $_SESSION['section7Amount'] = $_POST['advisorAmount'];
  $_SESSION['section7Names'] = $_POST['name'];
  $_SESSION['section7AdvisorTypes'] = $_POST['advisortype'];
  $_SESSION['section7Genders'] = $_POST['gender'];
  $_SESSION['section7OtherGenders'] = $_POST['other'];
  $_SESSION['section7ClubNames'] = $_POST['rotaryClubName'];
  $_SESSION['section7Emails'] = $_POST['email'];
  $_SESSION['section7Phones'] = $_POST['phone'];
  $_SESSION['section7Diets'] = $_POST['diet'];
  $_SESSION['section7OtherDiets'] = $_POST['otherDiet'];
