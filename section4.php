...
<input type="text" name="rotaractClubName" class="form-control" placeholder="I.e. ASU Rotaract Club, Grand Canyon University Rotaract Club, etc." aria-describedby="sizing-addon1">
      </div>
...
<input type="text" name="age" class="form-control" placeholder="I.e. 18, 28, etc." aria-describedby="sizing-addon1">
      </div>
