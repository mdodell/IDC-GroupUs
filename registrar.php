            ...
            <script>
                function getInput(input){
                    if(document.getElementById('password').validity.valid && document.getElementById('password').value == "idc5495"){
                        ...
                        $htmlHolder .= '<h4>Total Number of Early Bird Registered:</h4>';
                        $htmlHolder .= '<p>' . $totalCount . '</p>';
                        $htmlHolder .= '<h4>Total Number of Non-Early Bird Registered:</h4>';
                        $htmlHolder .= '<p>' . $postEarlyCount . '</p>';

                        $htmlHolder .= '<h4>Total $ Amount Owed:</h4>';
                        $htmlHolder .= '<p>$' . (($totalCount * 20) + ($postEarlyCount * 25)) . '</p>';
